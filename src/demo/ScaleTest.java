...
import com.corax.transformations.scale.ScaleInvoker;
...
public class ScaleTest {
	public static void main(String[] args) throws IOException {
		...
		ITransformationInvoker invoker = new ScaleInvoker(200,100);
		ITransformationInvoker invoker1 = new ScaleInvoker(800,700);
