...
public final class RasterUtils {
	...
	public static boolean mapFloatMapToRaster(float fmap[][], float fmin, float fmax, int[] colMin, int[] colMax,
	...
	/**
	 * Rasterizacija matrice float vrijednosti u RGB(A) raster linearno
	 * interpolirajući kroz gradijent (array) boja.
	 * 
	 * @param fmap
	 *            2D float matrica
	 * @param fmin
	 *            minimum opsega float vrijednosti (one ispod će biti zaokružene na
	 *            ovu)
	 * @param fmax
	 *            maksimum opsega float vrijednosti (one preko će biti zaokružene na
	 *            ovu)
	 * @param gradient
	 *            niz RGB(A) boja koje će biti proporcionalno raspoređene u
	 *            gradijent
	 * @param raster
	 *            raster u koji će biti upisana slika
	 * @return uspjeh operacije, false ako se dimenzije ne poklapaju ili raster nije
	 *         podržanog tipa
	 */
	public static boolean mapFloatMapViaGradient(float fmap[][], float fmin, float fmax, int[][] gradient,
			WritableRaster raster) {
